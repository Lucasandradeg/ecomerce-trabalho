// Arquivo: js/catalogo.js (Versão Final Corrigida)
...
// Disponibiliza a lista de produtos para outros scripts, como o produto.js
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Só adiciona os 'escutadores' se os elementos de filtro existirem na página atual
    ...
    // A renderização inicial só deve acontecer se o elemento 'catalogo' existir
    if (catalogo) {
